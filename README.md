This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). To start the project run: npm start. To install the dependencies run: npm install
